...
- **JDK** (`>=17.0.18`)
- **FlatLaf** (`>=3.7` [](https://www.formdev.com/flatlaf/))
...
- [] Restart method.
- [] Rework how cell states are used and stored (Collections framework and Stream API).
- [] Learn more about `enum` and make a class with methods instead of just using `.ordinal()` function.

### Display
- [x] Write code for displaying game field.
- [] Make a timer, a mine counter and an iconic smiling face icon displaying alongside with the game field.
- [] Do something about recursive empty cell opening method.
